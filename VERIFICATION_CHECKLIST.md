...
- [x] Replace UI/rendering “magic numbers” with named constants (keep visuals identical).
    - Evidence: All rendering constants extracted in Renderer.cs, WeatherEffects.cs, ParticleSystem.cs, NotificationManager.cs, etc.; Logic layer constants extracted in AchievementEvaluator.cs and EcosystemHealthScorer.cs
