...
public static class UIConstants
{
    ...
    /// </summary>
    public const double ENTITYCLICKTOLERANCEPIXELS = 30.0;
    ...
    /// </summary>
    public const double CREATURECLICKTOLERANCEPIXELS = 25.0;

    /// <summary>
    /// Default simulation speed multipliers available to the user.
    /// Provides common speed presets: normal, 2x, 5x, and 10x.
    /// </summary>
    public static readonly double[] SIMULATIONSPEEDPRESETS = { 1.0, 2.0, 5.0, 10.0 };
}
