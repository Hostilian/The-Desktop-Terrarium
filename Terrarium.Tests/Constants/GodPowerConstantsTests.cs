...
public class GodPowerConstantsTests
{
    ...
    {
        Assert.IsGreaterThan(0.0, GodPowerConstants.LIGHTNINGSTRIKEDAMAGE,
    ...
    {
        Assert.IsGreaterThan(0, GodPowerConstants.LIGHTNINGSTRIKETARGETCOUNT,
    ...
    {
        Assert.IsGreaterThan(0.0, GodPowerConstants.METEORBASEDAMAGE,
    ...
    {
        Assert.IsGreaterThan(0, GodPowerConstants.METEORSHOWERCOUNT,
    ...
    {
        Assert.IsGreaterThan(0.0, GodPowerConstants.METEORIMPACTRADIUSPIXELS,
    ...
    {
        Assert.IsGreaterThan(0.0, GodPowerConstants.PLAGUEINITIALDAMAGE,
    ...
    {
        Assert.IsGreaterThan(0, GodPowerConstants.PLAGUEINFECTIONCOUNT,
    ...
    {
        Assert.IsGreaterThan(1.0, GodPowerConstants.FERTILITYBLESSINGMULTIPLIER,
    ...
    {
        Assert.IsGreaterThan(0.0, GodPowerConstants.FERTILITYBLESSINGDURATIONSECONDS,
    ...
    {
        Assert.IsGreaterThan(0, GodPowerConstants.ABUNDANCEPLANTCOUNT,
    ...
    {
        Assert.IsGreaterThan(0, GodPowerConstants.CORRUPTIONTARGETCOUNT,
